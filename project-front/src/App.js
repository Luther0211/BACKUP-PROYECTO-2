...
*/
  ...
  //<Button type="danger" block onClick={this.logOut} >Cerrar sesión</Button>
  //</ul>
...
//this.setState({index:false})
  onClickLink = () => {
      this.setState({index:true, video: {'display':'none'}})
  }

  onClickTitle = () => {
    this.setState({index:false, video: {'display':'block'}})
  }


  //<Index style={this.state.video}/>
      ...
      <div className="App">
        ...
        <header className="main-head">
          <nav className="head-nav">
            <ul className="menu">
              <li>
                <Link id="linkHome" exact to="/" onClick={this.onClickTitle} >HOME</Link>
              </li>
              <li>
                <Link to='/profile' onClick={this.onClickLink}>
                  <svg className="person">
                    <use xmlnsXlink="http://www.w3.org/1999/xlink" xlinkHref="#person" />
                  </svg><span>Profile</span></Link>
              </li>
              <li>
                <Link to="/posts" onClick={this.onClickLink}>
